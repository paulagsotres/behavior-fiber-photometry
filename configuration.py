...
dir_path = Path(r"H:\Experiments\2023\20230614- MitoGcaMP6 OB CB1 KO\Odor stress and NOR\TEST PHASE") #change to point to folder
...
name_behav = "*BEHAVIOR*.csv" #what item do your behavioral files have to identify them PUT ** AROUND THE WORD
